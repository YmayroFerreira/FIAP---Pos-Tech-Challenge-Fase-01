...
interface ChartData {
	date: string;
	entradas: number; // Credits
	saidas: number; // Debits (as positive values)
...
const FinancialChart: React.FC<FinancialChartProps> = ({
	...
	// Process transactions into chart data using useMemo for performance
	...
	const { totalEntradas, totalSaidas, saldoAtual } = useMemo(() => {
		...
		const totalSaidas = chartData.reduce(
